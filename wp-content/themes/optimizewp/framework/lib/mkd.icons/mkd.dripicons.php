...
/**
 * Class OptimizeMikadoDripicons
 */
class OptimizeMikadoDripicons implements iOptimizeMikadoIconCollection {
    /**
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->styleUrl = MIKADO_ASSETS_ROOT . "/css/dripicons/dripicons.css";
    }
    ...
    public function render($icon, $params = array()) {
        ...
        $html .= '<i class="mkdf-icon-dripicons dripicon ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></i>';
