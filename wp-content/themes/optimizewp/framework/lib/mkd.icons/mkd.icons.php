...
/*
  Class: OptimizeMikadoIconCollections
...
class OptimizeMikadoIconCollections {
	...
	private function initIconCollections() {
		$this->addIconCollection('font_awesome', new OptimizeMikadoIconsFontAwesome("Font Awesome", "fa_icon"));
		$this->addIconCollection('font_elegant', new OptimizeMikadoIconsFontElegant("Font Elegant", "fe_icon"));
		$this->addIconCollection('ion_icons', new OptimizeMikadoIonIcons("Ion Icons", "ion_icon"));
		$this->addIconCollection('linea_icons', new OptimizeMikadoLineaIcons('Linea Icons', 'linea_icon'));
		$this->addIconCollection('simple_line_icons', new OptimizeMikadoSimpleLineIcons('Simple Line Icons',
			'simple_line_icons'));
		$this->addIconCollection('dripicons', new OptimizeMikadoDripicons('Dripicons', 'dripicon'));
	}
	...
	public function getIconCollectionIcons(iOptimizeMikadoIconCollection $collection) {
...
$optimize_mikado_IconCollections = OptimizeMikadoIconCollections::get_instance();