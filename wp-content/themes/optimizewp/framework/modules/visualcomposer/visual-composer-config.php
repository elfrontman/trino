...
if ( ! function_exists('optimize_mikado_configure_visual_composer') ) {
	/**
	 * Configuration for Visual Composer
	 * Hooks on vc_after_init action
	 */
	function optimize_mikado_configure_visual_composer() {
	...
	add_action('vc_after_init', 'optimize_mikado_configure_visual_composer');

}


if ( ! function_exists('optimize_mikado_configure_visual_composer_grid_elemets') ) {
	...
	function optimize_mikado_configure_visual_composer_grid_elemets() {
	...
	add_action('vc_after_init', 'optimize_mikado_configure_visual_composer_grid_elemets');
}


if ( ! function_exists('optimize_mikado_configure_visual_composer_frontend_editor') ) {
	/**
	 * Configuration for Visual Composer FrontEnd Editor
	 * Hooks on vc_after_init action
	 */
	function optimize_mikado_configure_visual_composer_frontend_editor() {
	...
	add_action('vc_after_init', 'optimize_mikado_configure_visual_composer_frontend_editor');
}
...
if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
	...
	class WPBakeryShortCode_Mkdf_Pricing_Tables extends WPBakeryShortCodesContainer {}
	class WPBakeryShortCode_Mkdf_Animations_Holder extends WPBakeryShortCodesContainer {}
	class WPBakeryShortCode_Mkdf_Process_Holder extends WPBakeryShortCodesContainer {}
	class WPBakeryShortCode_Mkdf_Comparison_Pricing_Tables_Holder extends WPBakeryShortCodesContainer {}
}

if ( class_exists( 'WPBakeryShortCode' ) ) {
	class WPBakeryShortCode_Mikadof_Pricing_Table extends WPBakeryShortCode {}
}

/*** Row ***/
if ( ! function_exists('optimize_mikado_vc_row_map') ) {
	/**
	 * Map VC Row shortcode
	 * Hooks on vc_after_init action
	 */
	function optimize_mikado_vc_row_map()
	{
		...
		vc_add_param('vc_row', array(
			...
			'value' => array(
				'Default' => '',
				'Light' => 'mkdf-light-header',
				'Dark' => 'mkdf-dark-header'
			),
	...
	add_action('vc_after_init', 'optimize_mikado_vc_row_map');
}
