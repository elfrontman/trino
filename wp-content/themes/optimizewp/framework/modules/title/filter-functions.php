...
if(!function_exists('optimize_mikado_title_classes')) {
	/**
	 ...
	 */
	function optimize_mikado_title_classes($classes = array()) {
		$classes = array();
		$classes = apply_filters('optimize_mikado_title_classes', $classes);
...
if(!function_exists('optimize_mikado_title_type_class')) {
	/**
	 ...
	 */
	function optimize_mikado_title_type_class($classes) {
		$id = optimize_mikado_get_page_id();

		if(($meta_temp = get_post_meta($id, "mkdf_title_area_type_meta", true)) !== "") {
			$title_type = $meta_temp;
		} else {
			$title_type = optimize_mikado_options()->getOptionValue('title_area_type');
		}
	...
	add_filter('optimize_mikado_title_classes', 'optimize_mikado_title_type_class');
}

if(!function_exists('optimize_mikado_title_background_image_classes')) {
	/**
	 * @param $classes
	 *
	 * @return array
	 */
	function optimize_mikado_title_background_image_classes($classes) {
		//init variables
		$id                      = optimize_mikado_get_page_id();
		$is_img_responsive       = '';
		$is_image_parallax       = '';
		...
		if(($meta_temp = get_post_meta($id, "mkdf_title_area_background_image_meta", true)) != "") {
			...
			$title_img = optimize_mikado_options()->getOptionValue('title_area_background_image');
		}
		...
		if(($meta_temp = get_post_meta($id, "mkdf_title_area_background_image_parallax_meta", true)) != "") {
			...
			$is_image_parallax = optimize_mikado_options()->getOptionValue('title_area_background_image_parallax');
		}
	...
	add_filter('optimize_mikado_title_classes', 'optimize_mikado_title_background_image_classes');
}

if(!function_exists('optimize_mikado_title_content_alignment_class')) {
	/**
	 ...
	 * @return array changed array of classes
	 */
	function optimize_mikado_title_content_alignment_class($classes) {
		...
		if(($meta_temp = get_post_meta($id, "mkdf_title_area_content_alignment_meta", true)) != "") {
			...
			$title_content_alignment = optimize_mikado_options()->getOptionValue('title_area_content_alignment');
		}
	...
	add_filter('optimize_mikado_title_classes', 'optimize_mikado_title_content_alignment_class');
}

if(!function_exists('optimize_mikado_title_animation_class')) {
	/**
	 ...
	 * @return array changed array of classes
	 */
	function optimize_mikado_title_animation_class($classes) {
		...
		if(($meta_temp = get_post_meta($id, "mkdf_title_area_animation_meta", true)) !== "") {
			...
			$title_animation = optimize_mikado_options()->getOptionValue('title_area_animation');
		}
	...
	add_filter('optimize_mikado_title_classes', 'optimize_mikado_title_animation_class');
}

if(!function_exists('optimize_mikado_title_background_image_div_classes')) {
	/**
	 * @param $classes
	 *
	 * @return array
	 */
	function optimize_mikado_title_background_image_div_classes($classes) {
	...
	add_filter('optimize_mikado_title_classes', 'optimize_mikado_title_background_image_div_classes');
}

if(!function_exists('optimize_mikado_title_size_body_class')) {
	/**
	 * @param $classes
	 *
	 * @return array
	 */
	function optimize_mikado_title_size_body_class($classes) {
		$id                  = optimize_mikado_get_page_id();
	...
	add_action('body_class', 'optimize_mikado_title_size_body_class');
}

if(!function_exists('optimize_mikado_has_subtitle_body_class')) {
	/**
	 * @param $classes
	 *
	 * @return array
	 */
	function optimize_mikado_has_subtitle_body_class($classes) {
		$id                    = optimize_mikado_get_page_id();
	...
	add_action('body_class', 'optimize_mikado_has_subtitle_body_class');
}