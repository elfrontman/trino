...
<?php } ?>
	...
	<div class="mkdf-call-to-action <?php echo esc_attr($type) ?>" <?php optimize_mikado_inline_style($call_to_action_styles); ?>>
		...
		<?php } elseif ($grid_size == "66") { ?>
			<div class="mkdf-call-to-action-row-66-33 clearfix">
		<?php } else { ?>
			<div class="mkdf-call-to-action-row-50-50 clearfix">
		<?php } ?>
				...
				<?php } ?>
					...
					<div class="mkdf-call-to-action-text" <?php echo optimize_mikado_get_inline_style($content_styles) ?>>
				...
				<?php if ($show_button == 'yes') { ?>
					...
					<div class="mkdf-button-wrapper mkdf-call-to-action-column2 mkdf-call-to-action-cell" style ="text-align: <?php echo esc_attr($button_position) ?> ;">
						...
						<?php echo optimize_mikado_get_button_html($button_parameters); ?>
