...
namespace Optimize\Modules\Shortcodes\ComparisonPricingTables;
...
class ComparisonPricingTablesHolder implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		return optimize_mikado_get_shortcode_module_template_part('templates/cpt-holder-template', 'comparison-pricing-tables', '', $params);
	}
