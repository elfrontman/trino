<?php
namespace Optimize\Modules\PricingTable;
...
class PricingTable implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		if(!empty($params['title_size'])) {
			$params['title_styles'][] = 'font-size: '.optimize_mikado_filter_px($params['title_size']).'px';
		}

		$html .= optimize_mikado_get_shortcode_module_template_part('templates/pricing-table-template', 'pricing-table', '', $params);
