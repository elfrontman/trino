<?php
namespace Optimize\Modules\PieCharts\PieChartDoughnut;
...
class PieChartDoughnut implements ShortcodeInterface {
	...
	public function __construct() {
		$this->base = 'mkdf_pie_chart_doughnut';
	...
	public function render($atts, $content = null) {
		...
		$html = optimize_mikado_get_shortcode_module_template_part('templates/pie-chart-doughnut', 'piecharts/piechartdoughnut', '', $params);
