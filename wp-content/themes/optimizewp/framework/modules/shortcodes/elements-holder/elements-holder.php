<?php
namespace Optimize\Modules\ElementsHolder;
...
class ElementsHolder implements ShortcodeInterface{
	...
	public function vcMap() {
		vc_map( array(
			...
			'category' => 'by MIKADO',
			'as_parent' => array('only' => 'mkdf_elements_holder_item, mkdf_info_box'),
	...
	public function render($atts, $content = null) {
		...
		$html .= '<div ' . optimize_mikado_get_class_attribute($elements_holder_class) . ' ' . optimize_mikado_get_inline_attr($elements_holder_style, 'style'). '>';
