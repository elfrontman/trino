<?php
namespace Optimize\Modules\ElementsHolderItem;
...
class ElementsHolderItem implements ShortcodeInterface{
	...
	public function vcMap() {
		if(function_exists('vc_map')){
			vc_map( 
				array(
					'name' => 'Elements Holder Item', 'optimize',
					'base' => $this->base,
	...
	public function render($atts, $content = null) {
		...
		$rand_class = 'mkdf-elements-holder-custom-' . mt_rand(100000,1000000);
		...
		$html = optimize_mikado_get_shortcode_module_template_part('templates/elements-holder-item-template', 'elements-holder', '', $params);
	...
	private function getElementsHolderItemClass($params) {
		...
		if ($params['animation_name'] !== '') {
			$element_holder_item_class[] = 'mkdf-'. $params['animation_name'];
		}
	...
	private function getData($params) {
		...
		if($params['animation_name'] !== '') {
			$data['data-animation'] = 'mkdf-'.$params['animation_name'];
		}
