<?php
namespace Optimize\Modules\Shortcodes\ImageGallery;
...
class ImageGallery implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		if($params['type'] === 'slider') {
			$params['holder_classes'][] = 'mkdf-image-gallery';

			if($params['navigation_style'] !== '') {
				$params['holder_classes'][] = 'mkdf-image-gallery-navigation-'.$params['navigation_style'];
			}
		}

		$params['space'] = $image_space;

		$html = optimize_mikado_get_shortcode_module_template_part('templates/'.$template, 'imagegallery', '', $params);
