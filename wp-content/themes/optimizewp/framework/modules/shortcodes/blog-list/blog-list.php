...
namespace Optimize\Modules\BlogList;
...
class BlogList implements ShortcodeInterface {
		...
		vc_map(array(
			...
			'params'                    => array(
				array(
					...
					'holder'      => 'div',
					'class'       => '',
					'heading'     => esc_html__('Type', 'optimize'),
					'param_name'  => 'type',
					'value'       => array(
	...
	public function render($atts, $content = null) {
		...
		$html = '';
		$html .= optimize_mikado_get_shortcode_module_template_part('templates/blog-list-holder', 'blog-list', '', $params);
	...
	private function generateImageSize($params) {
		...
		switch($imageSize) {
			case 'landscape':
				$thumbImageSize = 'optimize_mikado_landscape';
				break;
			case 'square';
				$thumbImageSize = 'optimize_mikado_square';
				break;
			default:
				$thumbImageSize = 'full';
				break;
