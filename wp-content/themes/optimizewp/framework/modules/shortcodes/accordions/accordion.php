<?php
namespace Optimize\Modules\Accordion;
...
class Accordion implements ShortcodeInterface{
	...
	public function vcMap() {
		...
		vc_map( array(
			'name'                      =>  esc_html__( 'Accordion', 'optimize' ),
			'base'                      => $this->base,
			...
			'params' => array(
				array(
					'type'          => 'textfield',
					'heading'       => esc_html__( 'Extra class name', 'optimize' ),
					'param_name'    => 'el_class',
					'description'   => esc_html__( 'Style particular content element differently - add a class name and refer to it in custom CSS.', 'optimize' )
				),
				array(
					'type'       => 'dropdown',
					'class'      => '',
	...
	public function render($atts, $content = null) {
		...
		$output .= optimize_mikado_get_shortcode_module_template_part('templates/accordion-holder-template','accordions', '', $params);
