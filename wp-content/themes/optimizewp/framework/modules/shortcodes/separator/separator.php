<?php
namespace Optimize\Modules\Separator;
...
class Separator implements ShortcodeInterface{
	...
	public function render($atts, $content = null) {
		...
		$html = optimize_mikado_get_shortcode_module_template_part('templates/separator-template', 'separator', '', $params);
	...
	private function getSeparatorStyle($params) {
		...
		if ($params['width'] !== '') {
			if(optimize_mikado_string_ends_with($params['width'], '%') || optimize_mikado_string_ends_with($params['width'], 'px')) {
		...
		if ($params['top_margin'] !== '') {
			if(optimize_mikado_string_ends_with($params['top_margin'], '%') || optimize_mikado_string_ends_with($params['top_margin'], 'px')) {
		...
		if ($params['bottom_margin'] !== '') {
			if(optimize_mikado_string_ends_with($params['bottom_margin'], '%') || optimize_mikado_string_ends_with($params['bottom_margin'], 'px')) {
