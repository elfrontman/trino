<?php
namespace Optimize\Modules\IconListItem;
...
class IconListItem implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$args = array_merge($args, optimize_mikado_icon_collections()->getShortcodeParams());
		...
		if($params['margin_bottom'] !== '') {
			$params['holder_styles'][] = 'margin-bottom: '.optimize_mikado_filter_px($params['margin_bottom']).'px';
		}
		...
		$html = optimize_mikado_get_shortcode_module_template_part('templates/icon-list-item-template', 'icon-list-item', '', $params);
	...
	private function getIconStyle($params) {
		...
		if(!empty($params['icon_size'])) {
			$iconStylesArray[] = 'font-size:'.optimize_mikado_filter_px($params['icon_size']).'px';
		}
	...
	private function getTitleStyle($params) {
		...
		if(!empty($params['title_size'])) {
			$titleStylesArray[] = 'font-size:'.optimize_mikado_filter_px($params['title_size']).'px';
		}
		...
		if(!empty($params['space_title_and_icon'])) {
			$titleStylesArray[] = 'padding-left: '.optimize_mikado_filter_px($params['space_title_and_icon']).'px';
		}
