<?php
namespace Optimize\Modules\Shortcodes\AnimationsHolder;
...
class AnimationsHolder implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		if($params['easing_type'] !== '') {
			$params['class'][] = 'mkdf-animation-'.$params['easing_type'];
		}
		...
		return optimize_mikado_get_shortcode_module_template_part('templates/animations-holder-template', 'animations-holder', '', $params);
	}
