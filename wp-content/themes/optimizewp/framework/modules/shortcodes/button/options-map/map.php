...
if(!function_exists('optimize_mikado_button_map')) {
	function optimize_mikado_button_map() {
		...
		optimize_mikado_add_admin_field(array(
			...
			'parent'      => $panel,
			'options'     => optimize_mikado_get_btn_hover_animation_types()
		));
		...
		$outline_group = optimize_mikado_add_admin_group(array(
			'name'        => 'outline_group',
			'title'       => 'Outline Type',
		...
		$outline_row = optimize_mikado_add_admin_row(array(
			'name'   => 'outline_row',
			'next'   => true,
		...
		$outline_row2 = optimize_mikado_add_admin_row(array(
			'name'   => 'outline_row2',
			'next'   => true,
			'parent' => $outline_group
		));
		...
		//Solid type options
		$solid_group = optimize_mikado_add_admin_group(array(
			'name'        => 'solid_group',
			'title'       => 'Solid Type',
		...
		$solid_row = optimize_mikado_add_admin_row(array(
			'name'   => 'solid_row',
			'next'   => true,
			'parent' => $solid_group
		));
		...
		$solid_row2 = optimize_mikado_add_admin_row(array(
			'name'   => 'solid_row2',
			'next'   => true,
			'parent' => $solid_group
		));
	...
	add_action('optimize_mikado_options_elements_map', 'optimize_mikado_button_map');
}