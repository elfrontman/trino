<?php
namespace Optimize\Modules\Shortcodes\Button;
 ...
 * @package Optimize\Modules\Shortcodes\Button
 */
class Button implements ShortcodeInterface {
			...
			'params'                    => array_merge(
				...
				array(
					...
					array(
						...
						'heading'     => 'Margin',
						'param_name'  => 'margin',
						'description' => esc_html__('Insert margin in format: 0px 0px 1px 0px', 'optimize'),
						'admin_label' => true,
						'group'       => 'Design Options'
					)
				)
	...
	public function render($atts, $content = null) {
		...
		return optimize_mikado_get_shortcode_module_template_part('templates/'.$params['html_type'], 'button', '', $params);
	}
	...
	private function getButtonStyles($params) {
		...
		if(!empty($params['font_size'])) {
			$styles[] = 'font-size: '.optimize_mikado_filter_px($params['font_size']).'px';
		}
	...
	private function getHoverAnimation($params) {
		...
		return optimize_mikado_options()->getOptionValue('button_hover_animation');
	}
