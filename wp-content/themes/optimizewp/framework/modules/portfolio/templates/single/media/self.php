<div class="mkdf-self-hosted-video-holder">
    ...
    <div class="mkdf-video-wrap">
        <video itemprop="video" class="mkdf-self-hosted-video" poster="<?php echo esc_url($media['video_cover']); ?>" preload="auto">
            ...
            <object width="320" height="240" type="application/x-shockwave-flash" data="<?php echo esc_url(get_template_directory_uri().'/js/flashmediaelement.swf'); ?>">
                ...
                <img src="<?php echo esc_url($media['video_cover']); ?>" width="1920" height="800" title="No video playback capabilities" alt="Video thumb"/>
            </object>
        </video>
    </div>
</div>