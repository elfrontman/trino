 ...
 */
class OptimizeMikadoSocialIconWidget extends OptimizeMikadoWidget {
    /**
    ...
    public function __construct() {
        parent::__construct(
            ...
            'Mikado Social Icon Widget' // Name
        );
    ...
    protected function setParams() {
        $this->params = array_merge(
            optimize_mikado_icon_collections()->getSocialIconWidgetParamsArray(),
            array(
                array(
                    'type' => 'textfield',
                    'title' => 'Link',
    ...
    public function widget($args, $instance) {
	    ...
	    $holder_class = array('mkdf-social-icon-widget-holder');

	    $holder_class[] = 'mkdf-'.$icon_html;

        ?>

	    <?php print $args['before_widget']; ?>

        <a <?php optimize_mikado_class_attribute($holder_class); ?> <?php echo optimize_mikado_get_inline_attr($hover_color, 'data-hover-color'); ?> <?php optimize_mikado_inline_style($social_icon_styles) ?> href="<?php echo esc_html($link); ?>" target="<?php echo esc_attr($target); ?>">
