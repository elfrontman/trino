...
class OptimizeMikadoLatestPosts extends OptimizeMikadoWidget {
	protected $params;
	public function __construct() {
		parent::__construct(
			'mkdf_latest_posts_widget', // Base ID
			'Mikado Latest Post', // Name
			array( 'description' => esc_html__( 'Display posts from your blog', 'optimize' ), ) // Args
		);
	...
	public function widget($args, $instance) {
		...
		echo optimize_mikado_execute_shortcode('mkdf_blog_list', $params);
