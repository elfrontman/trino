...
if ( ! function_exists('optimize_mikado_mobile_header_options_map') ) {

	function optimize_mikado_mobile_header_options_map() {
	...
	//add_action( 'optimize_mikado_options_map', 'optimize_mikado_mobile_header_options_map');
