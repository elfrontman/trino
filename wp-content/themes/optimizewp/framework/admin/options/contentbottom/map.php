...
if ( ! function_exists('optimize_mikado_content_bottom_options_map') ) {

	function optimize_mikado_content_bottom_options_map() {
		...
		$panel_content_bottom = optimize_mikado_add_admin_panel(
			array(
		...
		$enable_content_bottom_area_container = optimize_mikado_add_admin_container(
			array(
				'parent'            => $panel_content_bottom,
	...
	add_action( 'optimize_mikado_options_map', 'optimize_mikado_content_bottom_options_map', 13);
