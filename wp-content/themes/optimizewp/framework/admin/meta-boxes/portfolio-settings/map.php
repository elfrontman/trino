...
if(!function_exists('optimize_mikado_map_portfolio_settings')) {
    function optimize_mikado_map_portfolio_settings() {
        $meta_box = optimize_mikado_add_meta_box(array(
	    ...
	    optimize_mikado_add_meta_box_field(array(
		    ...
		    'type'        => 'color',
		    'label'       => 'Overlay Color',
		    'description' => 'Choose color for portfolio overlay. This color will be used for hover overlays in all portfolio shortcodes',
		    'parent'      => $meta_box,
		    'options'     => array(
			    'default'            => 'Default',
