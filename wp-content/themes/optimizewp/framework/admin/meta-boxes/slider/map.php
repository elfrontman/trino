...
$slider_meta_box = optimize_mikado_add_meta_box(
    array(
        'scope' => array('slides'),
...
$video_meta_box = optimize_mikado_add_meta_box(
    array(
        'scope' => array('slides'),
...
$general_meta_box = optimize_mikado_add_meta_box(
    array(
        'scope' => array('slides'),
        'title' => 'Slide General',
...
$behaviours_meta_box = optimize_mikado_add_meta_box(
    array(
        'scope' => array('slides'),
...
$title_style_meta_box = optimize_mikado_add_meta_box(
    array(
        'scope' => array('slides'),
    ...
    $slide_title_border = optimize_mikado_add_meta_box_field(array(
        'label' => 'Border',
...
$subtitle_style_meta_box = optimize_mikado_add_meta_box(
    array(
        'scope' => array('slides'),
...
$text_style_meta_box = optimize_mikado_add_meta_box(
    array(
        'scope' => array('slides'),
...
$buttons_style_meta_box = optimize_mikado_add_meta_box(
    array(
        'scope' => array('slides'),
    ...
    $buttons_style_group_1 = optimize_mikado_add_admin_group(array(
        ...
        $row1 = optimize_mikado_add_admin_row(array(
            ...
            */
            ...
            optimize_mikado_add_meta_box_field(
                array(
                    'name'        => 'mkdf_slide_button_font_style',
                    'type'        => 'selectblanksimple',
                    'label'       => 'Font Style',
                    'parent'      => $row1,
                    'options'     => $optimize_mikado_options_fontstyle
        ...
        $row2 = optimize_mikado_add_admin_row(array(
            ...
            optimize_mikado_add_meta_box_field(
                array(
                    'name'        => 'mkdf_slide_button_letter_spacing',
                    'type'        => 'textsimple',
                    'label'       => 'Letter Spacing(px)',
                    'parent'      => $row2
                )
            ...
            optimize_mikado_add_meta_box_field(
                array(
                    'name'        => 'mkdf_slide_button_line_height',
                    'type'        => 'textsimple',
                    'label'       => 'Line Height (px)',
                    'parent'      => $row2
                )
        ...
        /*
        $row3 = optimize_mikado_add_admin_row(array(
            'name' => 'row3',
            'parent' => $buttons_style_group_1
        ));
            ...
            optimize_mikado_add_meta_box_field(
                array(
                    'name'        => 'mkdf_slide_button_text_align',
                    'type'        => 'selectblanksimple',
                    'label'       => 'Text Align',
                    'parent'      => $row3,
                    'options'     => array(
            ...
            optimize_mikado_add_meta_box_field(
                array(
                    'name'        => 'mkdf_slide_button_text_transform',
                    'type'        => 'selectblanksimple',
                    'label'       => 'Text Transform',
                    'parent'      => $row3,
                    'options'     => $optimize_mikado_options_texttransform
    ...
    /*
    $buttons_style_group_3 = optimize_mikado_add_admin_group(array(
        'title' => 'Size',
        'description' => 'Define button size',
        'name' => 'mkdf_buttons_style_group_3',
        'parent' => $buttons_style_meta_box
    ));
        $row1 = optimize_mikado_add_admin_row(array(
            'name' => 'row1',
    ...
    $buttons_style_group_4 = optimize_mikado_add_admin_group(array(
        ...
        $row1 = optimize_mikado_add_admin_row(array(
            ...
            optimize_mikado_add_meta_box_field(
                array(
                    'name'        => 'mkdf_slide_button_border_width',
                    'type'        => 'textsimple',
            ...
            optimize_mikado_add_meta_box_field(
                array(
                    'name'        => 'mkdf_slide_button_border_radius',
                    'type'        => 'textsimple',
    ...
    /*
    $buttons_style_group_6 = optimize_mikado_add_admin_group(array(
        'title' => 'Padding (px)',
    ...
    */
    ...
    /*
    $buttons_style_group_7 = optimize_mikado_add_admin_group(array(
    ...
    */
    ...
    /*
    $buttons2_style_group_3 = optimize_mikado_add_admin_group(array(
        'title' => 'Size',
        'description' => 'Define button size',
    ...
    /*
    $buttons2_style_group_6 = optimize_mikado_add_admin_group(array(
        'title' => 'Padding (px)',
        'description' => 'Please insert padding in format (top right bottom left) i.e. 5px 5px 5px 5px',
    ...
    $buttons2_style_group_7 = optimize_mikado_add_admin_group(array(
        'title' => 'Button Hover Animation',
        'description' => 'Define hover animation for button',
...
$content_positioning_meta_box = optimize_mikado_add_meta_box(
    array(
        'scope' => array('slides'),
