...
if (!class_exists('OptimizeMikadoMobileNavigationWalker')) {
	class OptimizeMikadoMobileNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				if($item->nolink == ""){
					...
					$item_output .= '<a onClick="JavaScript: return false;" '. $attributes .'>';
				}
