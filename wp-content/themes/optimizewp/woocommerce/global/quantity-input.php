...
<div class="mkdf-quantity-label">
	<h6><?php esc_html_e('Quantity', 'optimize'); ?></h6>
</div>
...
<div class="quantity mkdf-quantity-buttons">
	...
	<input type="text" step="<?php echo esc_attr( $step ); ?>" min="<?php echo esc_attr( $min_value ); ?>" max="<?php echo esc_attr( $max_value ); ?>" name="<?php echo esc_attr( $input_name ); ?>" value="<?php echo esc_attr( $input_value ); ?>" title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'optimize' ) ?>" class="input-text qty text mkdf-quantity-input" size="4" pattern="<?php echo esc_attr( $pattern ); ?>" inputmode="<?php echo esc_attr( $inputmode ); ?>" />
