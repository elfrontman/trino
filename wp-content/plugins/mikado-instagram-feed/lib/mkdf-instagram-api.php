...
include 'mkdf-instagram-helper.php';

/**
 * Class MikadofInstagramApi
 */
class MikadofInstagramApi {
    /**
    ...
    private $apiURL;
    /**
     * @var MikadofInstagramApi instance of current class
     */
    private static $instance;

    /**
     * Helper object
     * @var MikadofInstagramHelper
     */
    private $helper;

    const CODE_OPTION_NAME = 'mkdf_instagram_code';
    const USER_ID_OPTION_NAME = 'mkdf_instagram_user_id';
    const ACCESS_TOKEN_OPTION_NAME = 'mkdf_instagram_access_token';
    const CODE_REDIRECT_URI_OPTION_NAME = 'mkdf_instagram_code_redirect_uri';

    /**
     * Private constructor because of singletone pattern. It sets all necessary properties
     */
    private function __construct() {
	    $this->clientID = '8e01ba6ad327466ba5f15c38809d52a6';
	    $this->clientSecret = '3783708381b841219c5630ab67b3a178';
	    $this->redirectUri = 'http://demo.mikado-themes.com/instagram-app/instagram-redirect.php';
	    ...
	    $this->helper = new MikadofInstagramHelper();
    }
     ...
     * @return string
     *
     * @see MikadofInstagramApi::buildCurrentPageURI()
     */
     ...
     *
     * @see MikadofInstagramApi::fetchData()
     */
     ...
     * @return stdClass
     *
     * @see MikadofInstagramApi::getAccessToken()
     */
