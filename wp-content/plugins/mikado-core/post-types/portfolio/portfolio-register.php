...
class PortfolioRegister implements PostTypeInterface {
    ...
    private function registerPostType() {
        global $optimize_mikado_Framework, $optimize_mikado_options;
        ...
        if(mkd_core_theme_installed()) {
            $menuPosition = $optimize_mikado_Framework->getSkin()->getMenuItemPosition('portfolio');
            $menuIcon = $optimize_mikado_Framework->getSkin()->getMenuIcon('portfolio');

            if(isset($optimize_mikado_options['portfolio_single_slug'])) {
                if($optimize_mikado_options['portfolio_single_slug'] != ""){
                    $slug = $optimize_mikado_options['portfolio_single_slug'];
                }
            }
        }
