...
class PortfolioSlider implements Lib\ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		return optimize_mikado_execute_shortcode('mkdf_portfolio_list', $params);
	}
	...
	public function getThumbSize($params) {
		switch($params['image_size']) {
			case 'landscape':
				$thumbSize = 'optimize_mikado_landscape';
				break;
			case 'portrait':
				$thumbSize = 'optimize_mikado_portrait';
				break;
			case 'square':
				$thumbSize = 'optimize_mikado_square';
				break;
			case 'full':
				$thumbSize = 'full';
				break;
	...
	public function loadPortfolioItemTemplate($params) {
		$params['overlay_styles'] = mkd_core_get_portfolio_item_overlay_styles();

		echo mkd_core_get_shortcode_module_template_part('portfolio-slider/templates/portfolio-slider-item', 'portfolio', '', $params);
	}
