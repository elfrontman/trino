...
function mkd_slides_category_taxonomy_custom_fields($tag) {
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Anchor', 'mkd_core'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Effect on header (dark/light style)', 'mkd_core'); ?></label>
        </th>
        <td>
...
<!--    <tr class="form-field">-->
<!--        <th scope="row" valign="top">-->
<!--            <label for="shortcode">--><?php //_e('Show prev/next thumbs (except for side menu or passepartout)', 'mkd_core'); ?><!--</label>-->
<!--        </th>-->
<!--        <td>-->
...
<!--    </tr>-->
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Show slide number', 'mkd_core'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Parallax effect', 'mkd_core'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Time between slide transitions in milliseconds', 'mkd_core'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Slider height in px', 'mkd_core'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Responsive height', 'mkd_core'); ?></label>
        </th>
        <td>
    ...
    <tr class="form-field slider-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Breakpoint Coefficients 1 (values: 0-1, default value: 1)', 'mkd_core'); ?></label>
        </th>
        <td>
            <div class="inline">
                <label for="shortcode"><?php _e('Graphic', 'mkd_core'); ?></label>
            ...
            <div class="inline">
                <label for="shortcode"><?php _e('Title', 'mkd_core'); ?></label>
            ...
            <div class="inline">
                <label for="shortcode"><?php _e('Subtitle', 'mkd_core'); ?></label>
            ...
            <div class="inline">
                <label for="shortcode"><?php _e('Text', 'mkd_core'); ?></label>
            ...
            <div class="inline">
                <label for="shortcode"><?php _e('Button', 'mkd_core'); ?></label>
            ...
            <br/>
            <br/>
            <span class="description"><?php _e("screen width > 1600px for 'set1' and 'set2'", 'mkd_core'); ?></span>
        </td>
    </tr>
    <tr class="form-field slider-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Breakpoint Coefficients 2 (values: 0-1, default value: 1)', 'mkd_core'); ?></label>
        </th>
        <td>
            <div class="inline">
                <label for="shortcode"><?php _e('Graphic', 'mkd_core'); ?></label>
            ...
            <br/>
            <br/>
            <span class="description"><?php _e("screen width = [1200px,1600px] for 'set1', screen width = [1300px,1600px] for 'set2'", 'mkd_core'); ?></span>
        </td>
    </tr>
    <tr class="form-field slider-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Breakpoint Coefficients 3 (values: 0-1, default value: 0.8)', 'mkd_core'); ?></label>
        </th>
        <td>
            <div class="inline">
                <label for="shortcode"><?php _e('Graphic', 'mkd_core'); ?></label>
            ...
            <br/>
            <br/>
            <span class="description"><?php _e("screen width = [900px,1200px] for 'set1', screen width = [1000px,1300px] for 'set2'", 'mkd_core'); ?></span>
        </td>
    </tr>
    <tr class="form-field slider-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Breakpoint Coefficients 4 (values: 0-1, default value: 0.7)', 'mkd_core'); ?></label>
        </th>
        <td>
            <div class="inline">
                <label for="shortcode"><?php _e('Graphic', 'mkd_core'); ?></label>
            ...
            <br/>
            <br/>
            <span class="description"><?php _e("screen width = [650px,900px] for 'set1', screen width = [768px,1000px] for 'set2'", 'mkd_core'); ?></span>
        </td>
    </tr>
    <tr class="form-field slider-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Breakpoint Coefficients 5 (values: 0-1, default value: 0.6)', 'mkd_core'); ?></label>
        </th>
        <td>
            <div class="inline">
                <label for="shortcode"><?php _e('Graphic', 'mkd_core'); ?></label>
            ...
            <br/>
            <br/>
            <span class="description"><?php _e("screen width = [500px,650px] for 'set1', screen width = [567px,768px] for 'set2'", 'mkd_core'); ?></span>
        </td>
    </tr>
    <tr class="form-field slider-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Breakpoint Coefficients 6 (values: 0-1, default value: 0.5)', 'mkd_core'); ?></label>
        </th>
        <td>
            <div class="inline">
                <label for="shortcode"><?php _e('Graphic', 'mkd_core'); ?></label>
            ...
            <br/>
            <br/>
            <span class="description"><?php _e("screen width = [320px,500px] for 'set1', screen width = [320px,567px] for 'set2'", 'mkd_core'); ?></span>
        </td>
    </tr>
    <tr class="form-field slider-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Breakpoint Coefficients 7 (values: 0-1, default value: 0.4)', 'mkd_core'); ?></label>
        </th>
        <td>
            <div class="inline">
                <label for="shortcode"><?php _e('Graphic', 'mkd_core'); ?></label>
            ...
            <br/>
            <br/>
            <span class="description"><?php _e("screen width < 320px for 'set1' and 'set2'", 'mkd_core'); ?></span>
        </td>
    </tr>
    <tr class="form-field">
        <th scope="row" valign="top">
            <label for="shortcode"><?php _e('Slider shortcode', 'mkd_core'); ?></label>
        </th>
        <td>
            <input type="text" name="term_meta[shortcode]" id="term_meta[shortcode]" size="25" style="width:60%;" value="<?php echo esc_attr($tag->slug) ? "[mkdf_slider slider='".$tag->slug."' auto_start='yes' animation_type='slide' responsive_breakpoints='set1' show_navigation_arrows='yes' show_navigation_circles='yes']" : ""; ?>" readonly><br />
            <span class="description"><?php _e('Use this shortcode to insert it on page', 'mkd_core'); ?></span>
        </td>
    </tr>
...
function mkd_theme_columns($theme_columns) {
    $new_columns = array(
        ...
        'name' => __('Name', 'mkd_core'),
        'shortcode' => __('Shortcode', 'mkd_core'),
        'slug' => __('Slug', 'mkd_core'),
        'posts' => __('Posts', 'mkd_core')
    );
    return $new_columns;
}
...
function mkd_manage_theme_columns($out, $column_name, $theme_id) {
    ...
    switch ($column_name) {
        case 'shortcode':
            $out .= "[mkdf_slider slider='".$theme->slug."' auto_start='yes' animation_type='slide' responsive_breakpoints='set1' show_navigation_arrows='yes' show_navigation_circles='yes']";
            break;
