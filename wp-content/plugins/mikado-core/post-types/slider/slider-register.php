...
class SliderRegister implements Lib\PostTypeInterface {
    ...
    private function registerPostType() {
        ...
        if(mkd_core_theme_installed()) {
            $menuPosition = $optimize_mikado_Framework->getSkin()->getMenuItemPosition('slider');
            $menuIcon = $optimize_mikado_Framework->getSkin()->getMenuIcon('slider');
        }
    ...
    private function registerTax() {
        $labels = array(
            'name' => __( 'Sliders', 'mkd_core' ),
            'singular_name' => __( 'Slider', 'mkd_core' ),
