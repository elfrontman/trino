...
class Slider implements Lib\ShortcodeInterface {
    ...
    public function render($atts, $content = null) {
        ...
        extract(shortcode_atts(array("slider" => "", "responsive_breakpoints" => "set1", "auto_start" => "", "animation_type" => "", "show_navigation_arrows" => "yes", "show_navigation_circles" => "yes"), $atts));
        $html = "";
        ...
        if ($slider != "") {
            ...
            if (isset($slider_meta['anchor']) && $slider_meta['anchor'] != '') {
                $slider_anchor = 'data-mkdf-anchor="'.$slider_meta['anchor'].'"';
            }
            ...
            if ($slider_header_effect == 'yes') {
                $header_effect_class = 'mkdf-header-effect';
            } else {
                $header_effect_class = '';
            }
            ...
            if ($slider_parallax == 'no') {
                ...
                $slider_css_position_class = 'mkdf-relative-position';
            } else {
            ...
            if ($slider_thumbs == 'yes') {
                $slider_thumbs_class = 'mkdf-slider-thumbs';
            } else {
                $slider_thumbs_class = '';
            }
            ...
            if($slider_meta['slider_numbers'] == 'yes') {
                $slider_numbers_class = 'mkdf-slider-numbers';
                $slider_numbers = 'yes';
            } else {
            ...
            if ($height == "" || $height == "0") {
                $full_screen_class = "mkdf-full-screen";
                ...
                $full_screen_class = "";
                $height_class = "mkdf-has-height";
                if ($responsive_height == "yes") {
                    $responsive_height_class = "mkdf-responsive-height";
                } else {
                    $responsive_height_class = "";
                }
            ...
            if ($height != "" && $responsive_height == "yes") {
                $responsiveness_data = 'data-mkdf_responsive_breakpoints = "' . esc_attr($responsive_breakpoints) . '"';
            }
            ...
            $responsive_coefficients_graphic_data = 'data-mkdf_responsive_graphic_coefficients = "' . esc_attr($breakpoint1_graphic . ',' . $breakpoint2_graphic . ',' . $breakpoint3_graphic . ',' . $breakpoint4_graphic . ',' . $breakpoint5_graphic . ',' . $breakpoint6_graphic . ',' . $breakpoint7_graphic) . '"';
            $responsive_coefficients_title_data = 'data-mkdf_responsive_title_coefficients = "' . esc_attr($breakpoint1_title . ',' . $breakpoint2_title . ',' . $breakpoint3_title . ',' . $breakpoint4_title . ',' . $breakpoint5_title . ',' . $breakpoint6_title . ',' . $breakpoint7_title) . '"';
            $responsive_coefficients_subtitle_data = 'data-mkdf_responsive_subtitle_coefficients = "' . esc_attr($breakpoint1_subtitle . ',' . $breakpoint2_subtitle . ',' . $breakpoint3_subtitle . ',' . $breakpoint4_subtitle . ',' . $breakpoint5_subtitle . ',' . $breakpoint6_subtitle . ',' . $breakpoint7_subtitle) . '"';
            $responsive_coefficients_text_data = 'data-mkdf_responsive_text_coefficients = "' . esc_attr($breakpoint1_text . ',' . $breakpoint2_text . ',' . $breakpoint3_text . ',' . $breakpoint4_text . ',' . $breakpoint5_text . ',' . $breakpoint6_text . ',' . $breakpoint7_text) . '"';
            $responsive_coefficients_button_data = 'data-mkdf_responsive_button_coefficients = "' . esc_attr($breakpoint1_button . ',' . $breakpoint2_button . ',' . $breakpoint3_button . ',' . $breakpoint4_button . ',' . $breakpoint5_button . ',' . $breakpoint6_button . ',' . $breakpoint7_button) . '"';
            ...
            if ($auto == "yes") {
                $auto_start_class = "mkdf-auto-start";
            } else {
                $auto_start_class = "";
            }
            ...
            switch ($animation_type) {
                case 'fade':
                    $animation_type_class = 'mkdf-fade';
                    break;
                case 'slide-vertical-up':
                    $animation_type_class = 'mkdf-vertical-up';
                    break;
                case 'slide-vertical-down':
                    $animation_type_class = 'mkdf-vertical-down';
                    break;
                case 'slide-cover':
                    $animation_type_class = 'mkdf-slide-cover';
                    break;
                default:
            ...
            if($optimize_mikado_options['smooth_page_transitions'] == "yes" && $optimize_mikado_options['smooth_pt_spinner_type'] != "") {
                $ajax_loader = '<div class="mkdf-st-loader"><div class="mkdf-st-loader1">' . optimize_mikado_loading_spinners(true) . '</div></div>';
            }else{
                $ajax_loader = '<div class="mkdf-st-loader"><div class="mkdf-st-loader1">'. optimize_mikado_loading_spinner_pulse() .'</div></div>';
            }

            /* set slider preloader - end */

            /* set padding for slider arrows - start */
            $slider_arrows_padding = "padding-top: " . esc_attr($this->optimize_mikado_get_slider_navigation_padding()) . "px;";
            /* set padding for slider arrows - end */

            $html .= '<div id="mkdf-' . esc_attr($slider) . '" ' . $slider_anchor . ' ' . $responsiveness_data . ' ' . $responsive_coefficients_graphic_data . ' ' . $responsive_coefficients_title_data . ' ' . $responsive_coefficients_subtitle_data . ' ' . $responsive_coefficients_text_data . ' ' . $responsive_coefficients_button_data . ' class="carousel slide ' . esc_attr($animation_type_class . ' ' . $full_screen_class . ' ' . $responsive_height_class . ' ' . $height_class . ' ' . $auto_start_class . ' ' . $header_effect_class . ' ' . $slider_numbers_class .  ' ' . $slider_thumbs_class) . ' " ' . $slide_animation_timeout . ' ' . $data_height . ' ' . $data_parallax_effect . ' '.optimize_mikado_get_inline_style($slide_holder_height).'><div class="mkdf-slider-preloader">'.$ajax_loader.'</div>';
            $html .= '<div class="carousel-inner ' . esc_attr($slider_css_position_class) . '" '.optimize_mikado_get_inline_style($carouselinner_height).' '.$data_parallax_transform.'>';
            ...
            if (have_posts()) : $postCount = 0;
                while (have_posts()) : the_post();
                    ...
                    $title = get_the_title();
                    //get slider type
                    $slide_type = get_post_meta(get_the_ID(), "mkdf_slide_background_type", true);
                    //get slider image
                    $image = esc_url(get_post_meta(get_the_ID(), "mkdf_slide_image", true));
                    //get slider overlay pattern
                    $image_overlay_pattern = esc_url(get_post_meta(get_the_ID(), "mkdf_slide_overlay_image", true));
                    /* get slider thumbnail/graphic - start */
                    $thumbnail = esc_url(get_post_meta(get_the_ID(), "mkdf_slide_thumbnail", true));
                    $thumbnail_attributes = optimize_mikado_get_attachment_meta_from_url($thumbnail, array('width','height'));
                    ...
                    $thumbnail_animation = get_post_meta(get_the_ID(), "mkdf_slide_thumbnail_animation", true);
                    $thumbnail_link = "";
                    if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_thumbnail_link", true)) != "") {
                        $thumbnail_link = esc_url($meta_temp);
                    }

                    $thumbnail_class = "";
                    if ($thumbnail !== "") {
                        $thumbnail_class = "mkdf-has-thumbnail";
                    }
                    /* get slider thumbnail/graphic - end */

                    /* get slider video files - start */
                    $video_webm = esc_url(get_post_meta(get_the_ID(), "mkdf_slide_video_webm", true));
                    $video_mp4 = esc_url(get_post_meta(get_the_ID(), "mkdf_slide_video_mp4", true));
                    $video_ogv = esc_url(get_post_meta(get_the_ID(), "mkdf_slide_video_ogv", true));
                    $video_image = esc_url(get_post_meta(get_the_ID(), "mkdf_slide_video_image", true));
                    $video_overlay = get_post_meta(get_the_ID(), "mkdf_slide_video_overlay", true);
                    $video_overlay_image = esc_url(get_post_meta(get_the_ID(), "mkdf_slide_video_overlay_image", true));
                    /* get slider video files - end */

                    /* slider content settings - start */
                    $content_animation = get_post_meta(get_the_ID(), "mkdf_slide_content_animation", true);
                    $content_animation_direction = get_post_meta(get_the_ID(), "mkdf_slide_content_animation_direction", true);

                    $slide_content_style = "";
                    if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_text_content_top_margin", true)) != "") {
                        $slide_content_style .= "margin-top: " . esc_attr($meta_temp) . "px;";
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_text_content_bottom_margin", true)) != "") {
					...
					$slide_graphic_style = "";
					if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_graphic_top_padding", true)) != "") {
                        $slide_graphic_style .= "padding-top: " . esc_attr($meta_temp) . "px;";
                    }
					if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_graphic_bottom_padding", true)) != "") {
                        $slide_graphic_style .= "padding-bottom: " . esc_attr($meta_temp) . "px;";
                    }

                    $animate_image_class = "";
                    $animate_image_data = "";
                    if (get_post_meta(get_the_ID(), "mkdf_enable_image_animation", true) == "yes") {
                        $animate_image_class .= "mkdf-animate-image ";
                        $animate_image_class .= ($meta_temp = get_post_meta(get_the_ID(), "mkdf_enable_image_animation_type", true));
                        $animate_image_data .= "data-mkdf_animate_image='".$meta_temp."'";
                    }

                    /* slider thumb/graphic settings - end */

                    /* slider elements alignment - start */
                    $graphic_alignment = get_post_meta(get_the_ID(), "mkdf_slide_graphic_alignment", true);
                    $content_alignment = get_post_meta(get_the_ID(), "mkdf_slide_content_alignment", true);
                    $separate_text_graphic = get_post_meta(get_the_ID(), "mkdf_slide_separate_text_graphic", true);
                    /* slider elements alignment - end */


                    /* slider elements positioning - start */
                    $content_full_width_class = "";
                    if (get_post_meta(get_the_ID(), "mkdf_slide_content_full_width", true) == "yes" && get_post_meta(get_the_ID(), "mkdf_slide_content_vertical_middle", true) == "no") {
                        $content_full_width_class = "mkdf-slide-full-width";
                    }else if(get_post_meta(get_the_ID(), "mkdf_slide_vertical_content_full_width", true) == "yes" && get_post_meta(get_the_ID(), "mkdf_slide_content_vertical_middle", true) == "yes"){
						$content_full_width_class = "mkdf-slide-full-width";
					}

                    if (get_post_meta(get_the_ID(), "mkdf_slide_content_vertical_middle_type", true) == 'window_top') {
                        $slide_item_padding_value = 0;
                    } else {
                        $slide_item_padding_value = $this->optimize_mikado_get_slider_item_padding();
                    }

                    $content_vertical_middle_position_class = "";
                    $slide_item_padding = "";

                    if (get_post_meta(get_the_ID(), "mkdf_slide_content_vertical_middle", true) == "yes") {
                        $content_vertical_middle_position_class = "mkdf-content-vertical-middle";
						...
						if(($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_vertical_content_width", true)) != ""){
							$vertical_content_width = "width:" . esc_attr($meta_temp) . "%; position:relative; ";
						}
						if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_vertical_content_left", true)) != "") {
                            $vertical_content_xaxis = "left:" . esc_attr($meta_temp) . "%;";
                        }else if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_vertical_content_right", true)) != "") {
                                $vertical_content_xaxis = "right:" . esc_attr($meta_temp) . "%;";
                        }
                    } else {

                        if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_content_width", true)) != "") {
                            $content_width = "width:" . esc_attr($meta_temp) . "%;";
                        } else {
                            $content_width = "width:80%;";
                        }

                        if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_content_left", true)) != "") {
                            $content_xaxis = "left:" . esc_attr($meta_temp) . "%;";
                        } else {
                            if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_content_right", true)) != "") {
                                $content_xaxis = "right:" . esc_attr($meta_temp) . "%;";
                            } else {
                                $content_xaxis = "left: 10%;";
                            }
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_content_top", true)) != "") {
                            $content_yaxis_start = "top:" . esc_attr($meta_temp) . "%;";
                            $content_yaxis_end = "top:" . (esc_attr($meta_temp) - 10) . "%;";
                        } else {
                            if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_content_bottom", true)) != "") {
                        ...
                        if ($separate_text_graphic == 'yes' && ($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_text_width", true)) != "") {
                            $content_width = "width:" . esc_attr($meta_temp) . "%;";
                        }

                        if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_graphic_width", true)) != "") {
                            $graphic_width = "width:" . esc_attr($meta_temp) . "%;";
                        } else {
                            $graphic_width = "width:50%;";
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_graphic_left", true)) != "") {
                            $graphic_xaxis = "left:" . esc_attr($meta_temp) . "%;";
                        } else {
                            if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_graphic_right", true)) != "") {
                                $graphic_xaxis = "right:" . esc_attr($meta_temp) . "%;";
                            } else {
                                $graphic_xaxis = "left: 25%;";
                            }
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_graphic_top", true)) != "") {
                            $graphic_yaxis_start = "top:" . esc_attr($meta_temp) . "%;";
                            $graphic_yaxis_end = "top:" . (esc_attr($meta_temp) - 10) . "%;";
                        } else {
                            if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_graphic_bottom", true)) != "") {
                    ...
                    $header_style = "";
                    if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_header_style", true)) != "") {
                    ...
                    if ($slide_type == 'video') {
                        ...
                        $html .= '<div class="mkdf-video"><div class="mkdf-mobile-video-image" '.optimize_mikado_get_inline_style('background-image: url(' . esc_url($video_image) . ')').'></div><div class="mkdf-video-overlay';
                        ...
                        $html .= '</div><div class="mkdf-video-wrap">';
                        ...
                        $html .= '<div class="mkdf-image" '.optimize_mikado_get_inline_style('background-image:url(' . esc_url($image) . ')').'>';
                        if ($slider_thumbs == 'no') {
                            $html .= '<img src="' . esc_url($image) . '" alt="' . esc_attr($title) . '">';
                        }

                        if ($image_overlay_pattern !== "") {
                            $html .= '<div class="mkdf-image-pattern" '.optimize_mikado_get_inline_style('background: url(' . esc_url($image_overlay_pattern) . ') repeat 0 0').'></div>';
                        }
                        $html .= '</div>';
                    }
                    ...
                    if ($thumbnail != "") {
                        ...
                        $html_thumb .= '<div class="mkdf-thumb ' . esc_attr($thumbnail_animation) . '">';
                        if ($thumbnail_link != "") {
                    ...
                    $html_text = "";
                    $html_text .= '<div class="mkdf-text ' . esc_attr($content_animation . ' ' . $content_animation_direction) . ' " style="' . esc_attr($slide_content_style) . '">';

                    /* prepare slide subtitle - start */
                    if (($meta_temp_subtitle = get_post_meta(get_the_ID(), "mkdf_slide_subtitle", true)) != "") {
                        $slide_subtitle_style_array = array();
                        if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_subtitle_color", true)) != "") {
                            $slide_subtitle_style_array[] = "color: " . esc_attr($meta_temp);
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_subtitle_font_size", true)) != "") {
                            $slide_subtitle_style_array[] = "font-size: " . $meta_temp."px";
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_subtitle_line_height", true)) != "") {
                            $slide_subtitle_style_array[] = "line-height: " . $meta_temp . "px";
                        }
                        if ((($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_subtitle_font_family", true)) !== "-1") && ($meta_temp !== "")) {
                            $slide_subtitle_style_array[] = "font-family: '" . esc_attr(str_replace('+', ' ', $meta_temp)) . "'";
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_subtitle_font_style", true)) != "") {
                            $slide_subtitle_style_array[] = "font-style: " . esc_attr($meta_temp) . "";
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_subtitle_font_weight", true)) != "") {
                            $slide_subtitle_style_array[] = "font-weight: " . esc_attr($meta_temp) . "";
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_subtitle_letter_spacing', true) )!== '') {
                            $slide_subtitle_style_array[] = 'letter-spacing: ' . esc_attr($meta_temp) . 'px';
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_subtitle_text_transform', true) )!== '') {
                            $slide_subtitle_style_array[] = 'text-transform: ' . esc_attr($meta_temp) . '';
                        }
                        if (($meta_temp_hide_shadow = get_post_meta(get_the_ID(), 'mkdf_slide_hide_shadow', true)) == 'yes') {
                            $slide_subtitle_style_array[] = 'text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.4)';
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_subtitle_margin_bottom', true)) != '') {
                            $slide_subtitle_style_array[] = 'margin-bottom: ' . esc_attr($meta_temp) . 'px';
                        }

                        $slide_subtitle_span_style_array = array();
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_subtitle_background_color', true)) !== '') {
                            $slide_subtitle_bg_color = esc_attr($meta_temp);
                            if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_subtitle_bg_color_transparency', true)) != '') {
                                $slide_subtitle_bg_transparency = esc_attr($meta_temp);
                            } else {
                                $slide_subtitle_bg_transparency = 1;
                            }
                            $slide_subtitle_span_style_array[] = 'background-color: ' . esc_attr(optimize_mikado_rgba_color($slide_subtitle_bg_color, $slide_subtitle_bg_transparency)) . '';
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_subtitle_padding_top', true)) != '') {
                            $slide_subtitle_span_style_array[] = 'padding-top: ' . esc_attr($meta_temp) . 'px';
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_subtitle_padding_right', true)) != '') {
                            $slide_subtitle_span_style_array[] = 'padding-right: ' . esc_attr($meta_temp) . 'px';
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_subtitle_padding_bottom', true)) != '') {
                            $slide_subtitle_span_style_array[] = 'padding-bottom: ' . esc_attr($meta_temp) . 'px';
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_subtitle_padding_left', true)) != '') {
                            $slide_subtitle_span_style_array[] = 'padding-left: ' . esc_attr($meta_temp) . 'px';
                        }
                        $html_text .= '<div class="mkdf-el">';
                        //$html_text .= '<h3 class="mkdf-slide-subtitle" style="'.$slide_subtitle_style.'"><span style="'.$slide_subtitle_span_style.'">' . wp_kses_post(get_post_meta(get_the_ID(), 'mkdf_slide_subtitle', true)) . '</span></h3>';
                        //optimize_mikado_inline_style($slide_subtitle_style_array); var_dump($slide_subtitle_style_array); die();
                        $html_text .= '<h3 class="mkdf-slide-subtitle" '.optimize_mikado_get_inline_style($slide_subtitle_style_array).'><span '.optimize_mikado_get_inline_style($slide_subtitle_span_style_array).'>' . wp_kses_post($meta_temp_subtitle) . '</span></h3>';
                        $html_text .= '</div>';
                    }
                    ...
                    if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_title_color", true)) != "") {
                        $slide_title_style_array[] = "color: " . esc_attr($meta_temp) . "";
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_title_font_size", true)) != "") {
                        $slide_title_style_array[] = "font-size: " . esc_attr($meta_temp) . "px";
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_title_line_height", true)) != "") {
                        $slide_title_style_array[] = "line-height: " . esc_attr($meta_temp) . "px";
                    }
                    if ((($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_title_font_family", true)) !== "-1") && ($meta_temp !== "")) {
                        $slide_title_style_array[] = "font-family: '" . esc_attr(str_replace('+', ' ', $meta_temp)) . "'";
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_title_font_style", true)) != "") {
                        $slide_title_style_array[] = "font-style: " . esc_attr($meta_temp) . "";
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_title_font_weight", true)) != "") {
                        $slide_title_style_array[] = "font-weight: " . esc_attr($meta_temp) . "";
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_title_letter_spacing', true) )!== '') {
                        $slide_title_style_array[] = 'letter-spacing: ' . esc_attr($meta_temp) . 'px';
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_title_text_transform', true) )!== '') {
                    ...
                    if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_title_margin_bottom', true)) != '') {
                        $slide_title_style_array[] = 'margin-bottom: ' . esc_attr($meta_temp) . 'px';
                    }

                    $slide_title_span_style_array = array();
                    if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_title_background_color', true)) !== '') {
                        $slide_title_bg_color = esc_attr($meta_temp);
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_title_bg_color_transparency', true)) != '') {
                            $slide_title_bg_transparency = esc_attr($meta_temp);
                        } else {
                            $slide_title_bg_transparency = 1;
                        }
                        $slide_title_span_style_array[] = 'background-color: ' . esc_attr(optimize_mikado_rgba_color($slide_title_bg_color, $slide_title_bg_transparency)) . '';
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_title_padding_top', true)) != '') {
                        $slide_title_span_style_array[] = 'padding-top: ' . esc_attr($meta_temp) . 'px';
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_title_padding_right', true)) != '') {
                        $slide_title_span_style_array[] = 'padding-right: ' . esc_attr($meta_temp) . 'px';
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_title_padding_bottom', true)) != '') {
                        $slide_title_span_style_array[] = 'padding-bottom: ' . esc_attr($meta_temp) . 'px';
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_title_padding_left', true)) != '') {
                        $slide_title_span_style_array[] = 'padding-left: ' . esc_attr($meta_temp) . 'px';
                    }

                    $border_style_array = array();
                    if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_title_border', true)) != '' && $meta_temp == 'yes') {

                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_title_border_thickness', true)) != '') {
                            $border_style_array[] = 'border-width: ' . esc_attr($meta_temp) . 'px';
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_title_border_style', true)) != '') {
                            $border_style_array[] = 'border-style: ' . esc_attr($meta_temp) . '';
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slider_title_border_color', true)) != '') {
                    ...
                    if (get_post_meta(get_the_ID(), "mkdf_slide_hide_title", true) == 'no') {
                        $html_text .= '<div class="mkdf-el">';
                        $html_text .= '<h2 class="mkdf-slide-title" '.optimize_mikado_get_inline_style($slide_title_style_array).'>';

                        if(($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_title_link", true)) != '') {
                            $html_text .= '<a href="'.esc_url($meta_temp).'" target="'.esc_attr(get_post_meta(get_the_ID(), "mkdf_slide_title_target", true)).'">';
                        }
                        $html_text .= '<span '.optimize_mikado_get_inline_style($slide_title_span_style_array).'>'.wp_kses_post($title).'</span>';
                        if($meta_temp != '') {
                            $html_text .= '</a>';
                        }
                    ...
                    if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_text_color", true)) != "") {
                        $slide_text_style_array[] = "color: " . esc_attr($meta_temp) . "";
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_text_font_size", true)) != "") {
                        $slide_text_style_array[] = "font-size: " . esc_attr($meta_temp) . "px";
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_text_line_height", true)) != "") {
                        $slide_text_style_array[] = "line-height: " . esc_attr($meta_temp) . "px";
                    }
                    if ((($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_text_font_family", true)) !== "-1") && ($meta_temp !== "")) {
                        $slide_text_style_array[] = "font-family: '" . esc_attr(str_replace('+', ' ', $meta_temp)) . "'";
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_text_font_style", true)) != "") {
                        $slide_text_style_array[] = "font-style: " . esc_attr($meta_temp) . "";
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_text_font_weight", true)) != "") {
                        $slide_text_style_array[] = "font-weight: " . esc_attr($meta_temp) . "";
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_text_letter_spacing', true) )!== '') {
                        $slide_text_style_array[] = 'letter-spacing: ' . esc_attr($meta_temp) . 'px';
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_text_text_transform', true) )!== '') {
                        $slide_text_style_array[] = 'text-transform: ' . esc_attr($meta_temp) . '';
                    }
                    if ($meta_temp_hide_shadow == 'yes') {
                        $slide_text_style_array[] = 'text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.4)';
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_text_background_color', true) )!== '') {
                        $slide_text_bg_color = esc_attr($meta_temp);
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_text_bg_color_transparency', true)) != '') {
                            $slide_text_bg_transparency = esc_attr($meta_temp);
                        } else {
                            $slide_text_bg_transparency = 1;
                        }
                        $slide_text_span_style_array[] = 'background-color: ' . esc_attr(optimize_mikado_rgba_color($slide_text_bg_color, $slide_text_bg_transparency)) . '';
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_text_padding_top', true)) != '') {
                        $slide_text_span_style_array[] = 'padding-top: ' . esc_attr($meta_temp) . 'px';
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_text_padding_right', true)) != '') {
                        $slide_text_span_style_array[] = 'padding-right: ' . esc_attr($meta_temp) . 'px';
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_text_padding_bottom', true)) != '') {
                        $slide_text_span_style_array[] = 'padding-bottom: ' . esc_attr($meta_temp) . 'px';
                    }
                    if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_text_padding_left', true)) != '') {
                        $slide_text_span_style_array[] = 'padding-left: ' . esc_attr($meta_temp) . 'px';
                    }

                    /*
                    if (get_post_meta(get_the_ID(), "mkdf_slide_text", true) != "") {
                        $html_text .= '<div class="mkdf-el">';
                        if ($slide_text_separator_var == 'yes') {
                            $html_text .= do_shortcode('[vc_text_separator ' . implode(' ', $slide_text_with_separator_array ) . ']');
                        } else {
                            $html_text .= '<h3 class="mkdf-slide-text" '.mkdf_burst_get_inline_style($slide_text_style).'><span '.mkdf_burst_get_inline_style($slide_text_span_style).'>' . wp_kses_post(get_post_meta(get_the_ID(), "mkdf_slide-text", true)) . '</span></h3>';
                        }
                        $html_text .= '</div>';
                    }*/
                    if (($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_text", true)) != "") {
                        $html_text .= '<div class="mkdf-el">';
                        $html_text .= '<h3 class="mkdf-slide-text" '.optimize_mikado_get_inline_style($slide_text_style_array).'><span '.optimize_mikado_get_inline_style($slide_text_span_style_array).'>'.wp_kses_post($meta_temp).'</span></h3>';
                        $html_text .= '</div>';
                    }
                    ...
                    $meta_temp_b1_label = get_post_meta(get_the_ID(), "mkdf_slide_button_label", true);
                    $meta_temp_b1_icon_pack = get_post_meta(get_the_ID(), "mkdf_button1_icon_pack", true);
                    $meta_temp_b1_link = get_post_meta(get_the_ID(), "mkdf_slide_button_link", true);
                    ...
                    $meta_temp_b2_label = get_post_meta(get_the_ID(), "mkdf_slide_button_label2", true);
                    $meta_temp_b2_icon_pack = get_post_meta(get_the_ID(), "mkdf_button2_icon_pack", true);
                    $meta_temp_b2_link = get_post_meta(get_the_ID(), "mkdf_slide_button_link2", true);
                    ...
                    if ($is_any_button_shown) {
                        $html_text .= '<div class="mkdf-el">';
                        $html_text .= '<div class="mkdf-slide-buttons-holder">';
                    }


                    if ($is_first_button_shown) {
                        $button1_params = array();
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_button_size', true)) != '') {
                            $button1_params['size'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_button_type', true)) != '') {
                        ...
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_button_target', true)) != '') {
                            $button1_params['target'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_button_text_color', true)) != '') {
                            $button1_params['color'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_button_text_hover_color', true)) != '') {
                            $button1_params['hover_color'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_button_background_color', true)) != '') {
                            $button1_params['background_color'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_button_background_hover_color', true)) != '') {
                            $button1_params['hover_background_color'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_button_border_color', true)) != '') {
                            $button1_params['border_color'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_button_border_hover_color', true)) != '') {
                            $button1_params['hover_border_color'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_button_font_size', true)) != '') {
                            $button1_params['font_size'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_button_font_weight', true)) != '') {
                            $button1_params['font_weight'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_button_margin1', true)) != '') {
                            $button1_params['margin'] = $meta_temp;
                        }
                        if ($meta_temp_b1_icon_pack != '') {
                            $button1_params['icon_pack'] = $meta_temp_b1_icon_pack;
                            $iconPackName = optimize_mikado_icon_collections()->getIconCollectionParamNameByKey($button1_params['icon_pack']);
                        ...
                        $html_text .= optimize_mikado_get_button_html($button1_params);
                    }

                    if ($is_second_button_shown) {
                        $button2_params = array();
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_button_size2', true)) != '') {
                            $button2_params['size'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_button_type2', true)) != '') {
                        ...
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_button_target2', true)) != '') {
                            $button2_params['target'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_button_text_color2', true)) != '') {
                            $button2_params['color'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_button_text_hover_color2', true)) != '') {
                            $button2_params['hover_color'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_button_background_color2', true)) != '') {
                            $button2_params['background_color'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_button_background_hover_color2', true)) != '') {
                            $button2_params['hover_background_color'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_button_border_color2', true)) != '') {
                            $button2_params['border_color'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_button_border_hover_color2', true)) != '') {
                            $button2_params['hover_border_color'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_button_font_size2', true)) != '') {
                            $button2_params['font_size'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_button_font_weight2', true)) != '') {
                            $button2_params['font_weight'] = $meta_temp;
                        }
                        if (($meta_temp = get_post_meta(get_the_ID(), 'mkdf_slide_button_margin2', true)) != '') {
                            $button2_params['margin'] = $meta_temp;
                        }
                        if ($meta_temp_b2_icon_pack != '') {
                            $button2_params['icon_pack'] = $meta_temp_b2_icon_pack;
                            $iconPackName = optimize_mikado_icon_collections()->getIconCollectionParamNameByKey($button2_params['icon_pack']);
                            if (($meta_temp = get_post_meta(get_the_ID(), 'button2_icon_'.$iconPackName, true)) != '') {
                                $button2_params[$iconPackName] = $meta_temp;
                            }
                        }
                        //var_dump($button1_params); die();
                        $html_text .= optimize_mikado_get_button_html($button2_params);
                    }

                    if ($is_any_button_shown) {
                        $html_text .= '</div></div>'; //close div.mkdf-slide-button-holder
                    }
                    ...
                    $html_slider_anchor = '';
                    if (($meta_temp_anchor = get_post_meta(get_the_ID(), "mkdf_slide_scroll_to_section", true)) !== '') {
                        ...
                        if(($meta_temp_anchor_position = get_post_meta(get_the_ID(), "mkdf_slide_scroll_to_section_position", true)) == 'in_content' || $meta_temp_anchor_position == ''){
                            $slide_anchor_classes .= 'mkdf-el mkdf-slider-anchor-in-content';
                        }
                        elseif($meta_temp_anchor_position == 'bottom_of_slider'){
                            $slide_anchor_classes .= 'mkdf-slider-anchor-on-bottom-of-the-slider';
                        }

                        $html_slider_anchor = '<div class="mkdf-slide-anchor-holder '.esc_attr($slide_anchor_classes).'"><a ' . $slide_anchor_style . ' class="mkdf-slide-anchor-button mkdf-anchor" href="' . esc_url($meta_temp_anchor) . '"><i class="icon-mouse"></i><span class="scroll-text">Scroll Down</span></a></div>';
                    }

                    if($html_slider_anchor != '' && (($meta_temp_anchor_position = get_post_meta(get_the_ID(), "mkdf_slide_scroll_to_section_position", true)) == 'in_content' || $meta_temp_anchor_position == '')){
                    ...
                    $html .= '<div class="mkdf-slider-content-outer">';

                    if ($separate_text_graphic != 'yes') {
                        $html .= '<div class="mkdf-slider-content ' . esc_attr($content_alignment) .'" '.optimize_mikado_get_inline_style($content_width . $content_xaxis . $content_yaxis_start).' '.$slide_data_start.' '.$slide_data_end.'>';
							if(($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_content_vertical_middle", true)) == "yes"){
								$html .= '<div class="mkdf-slider-content-inner ' . esc_attr($content_animation . ' ' . $content_animation_direction) .'" '.optimize_mikado_get_inline_style($vertical_content_width . $vertical_content_xaxis).'>';
							}
							$html .= $html_thumb;
							$html .= $html_text;
							if($meta_temp == "yes"){
                        ...
                        $html .= '<div class="mkdf-slider-content mkdf-graphic-content ' . esc_attr($graphic_alignment) . '" '.optimize_mikado_get_inline_style($graphic_width . $graphic_xaxis . $graphic_yaxis_start).' '. $graphic_data_start .' '.$graphic_data_end.'>';
							if(($meta_temp = get_post_meta(get_the_ID(), "mkdf_slide_content_vertical_middle", true)) == "yes"){
								$html .= '<div class="mkdf-slider-content-inner" '.optimize_mikado_get_inline_style($vertical_content_width . $vertical_content_xaxis).'>';
							}
							$html .= $html_thumb;
							if($meta_temp == "yes"){
								$html .= '</div>';
                    ...
                    $html .= '</div>'; //close div.mkdf-slide-content-outer
                    $html .= '</div>'; //close div.item

                    $postCount++;
                endwhile;
            else:
                $html .= __('Sorry, no slides matched your criteria.', 'optimize');
            endif;
            wp_reset_query();
            ...
            if ($found_slides > 1) {
                if ($show_navigation_circles == "yes") {
                    ...
                    if (have_posts()) : $postCount = 0;
                        while (have_posts()) : the_post();
                            ...
                            $html .= '<li data-target="#mkdf-' . esc_attr($slider) . '" data-slide-to="' . esc_attr($postCount) . '"';
                            if ($postCount == 0) {
                                $html .= ' class="active"';
                            }
                            $html .= '></li>';
                        ...
                        $html .= __('Sorry, no posts matched your criteria.', 'optimize');
                    endif;
                ...
                if ($show_navigation_arrows == "yes") {
                    ...
                    $html .= '<div class="mkdf-controls-holder">';

                    $html .= '<a class="left carousel-control" style="'.$slider_arrows_padding.'" href="#mkdf-' . esc_attr($slider) . '" data-slide="prev" data-start="opacity: 1;" data-300="opacity:0;">';
                        if ($slider_thumbs == 'yes') {
                            $html .= '<span class="mkdf-thumb-holder"><span class="mkdf-thumb-arrow arrow_carrot-left"></span><span class="mkdf-numbers"><span class="prev"></span><span class="max-number"> / ' . esc_html($postCount) . '</span></span><span class="img"></span></span>';
                        }
                        $html .= '<span class="mkdf-prev-nav">';
                            if($slider_numbers == 'yes') {
                                $html .= '<span class="mkdf-numbers"><span class="prev"></span><span class="max-number"> / ' . esc_html($postCount) . '</span></span>';
                            }
                            $html .= '<span class="arrow_carrot-left"></span>';
                        $html .= '</span>';
                    $html .= '</a>';

                    $html .= '<a class="right carousel-control" style="'.$slider_arrows_padding.'" href="#mkdf-' . esc_attr($slider) . '" data-slide="next" data-start="opacity: 1;" data-300="opacity:0;">';
                        if ($slider_thumbs == 'yes') {
                            $html .= '<span class="mkdf-thumb-holder"><span class="mkdf-numbers"> <span class="next"></span><span class="max-number"> / ' . esc_html($postCount) . '</span></span><span class="mkdf-thumb-arrow arrow_carrot-right"></span><span class="img"></span></span>';
                        }

                        $html .= '<span class="mkdf-next-nav">';
                            if($slider_numbers == 'yes') {
                                $html .= '<span class="mkdf-numbers"> <span class="next"></span><span class="max-number"> / ' . esc_html($postCount) . '</span></span>';
                            }
                            $html .= '<span class="arrow_carrot-right"></span>';
                        $html .= '</span>';
                    $html .= '</a>';

                    $html .= '</div>'; //close of div.mkdf-controls-holder
                }
            }
     ...
     **/
    function optimize_mikado_get_slider_item_padding() {
        return apply_filters('optimize_mikado_slider_item_padding', 0);
    }

    /**
     * Function that returns slider navigation pading
     **/
    function optimize_mikado_get_slider_navigation_padding() {
        return apply_filters('optimize_mikado_slider_navigation_padding', 0);
    }
}